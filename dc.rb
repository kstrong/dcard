...
module DownloadCards
    ...
    class Public < DownloadCards::Base
    ...
    class Protected < DownloadCards::Base

        use Rack::Auth::Basic, "Protected Area" do |username, password|
            username == settings.manage_user && password == settings.manage_pass
        end
    ...
    class Application < Sinatra::Base
        ...
        use DownloadCards::Public
        use DownloadCards::Protected
